defmodule UrlshortenerWeb.LinkControllerTest do
  ...
  @create_attrs %{fullurl: "some fullurl", shorturl: "some shorturl"}
  @update_attrs %{fullurl: "some updated fullurl", shorturl: "some updated shorturl"}
  @invalid_attrs %{fullurl: nil, shorturl: nil}
  ...
  describe "update link" do
    ...
    test "redirects when data is valid", %{conn: conn, link: link} do
      ...
      assert html_response(conn, 200) =~ "some updated fullurl"
    end
